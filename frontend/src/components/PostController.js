...
class PostController extends Component {
    ...
    submitHandler = async () => {
        ...
        if (this.props.data.User != 'undefined') {
            ...
            const data = JSON.stringify({ "Title": this.state.title, "PostedBy": { "Username": this.props.data.User.Username, "Email": this.props.data.User.Email, "Password": "N/A" }, "Price": this.state.price, "Content": this.state.descirption, "Image": this.state.imageUrl, "Votes": { "Total": 0, "Up": [], "Down": [] } });
